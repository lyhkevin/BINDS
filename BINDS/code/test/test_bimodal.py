...
root = '/public/home/liyh2022/projects/BINDS/evaluation/bimodal/'
data = np.load(os.path.join(root, 'bimodal_predictions.npz'), allow_pickle=True)

preds_risk = data['preds_risk'].item()['bimodal']
preds_subtype = data['preds_subtype'].item()['bimodal']
...
test_cancer_subtype(
    ...
    title='Bimodal_Subtype'
)

tsne_plot(
    features=features_subtype,
    gt=gts_subtype,
    title='Bimodal Subtype t-SNE',
