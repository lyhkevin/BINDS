...
root = '/public/home/liyh2022/projects/BINDS/evaluation/mri/'
data = np.load(os.path.join(root, 'mri_predictions.npz'), allow_pickle=True)

preds_risk = data['preds_risk'].item()['mri']
preds_subtype = data['preds_subtype'].item()['mri']
